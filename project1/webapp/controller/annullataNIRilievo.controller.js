sap.ui.define([
    ...
    function (BaseController, Filter, FilterOperator, JSONModel, MessageBox, Spreadsheet, CoreLibrary, DateFormatter) {
        ...
        return BaseController.extend("project1.controller.annullataNIRilievo", {
            ...
            onInit() {
                ...
                //this.prePosition()
                this.getRouter().getRoute("annullataNIRilievo").attachPatternMatched(this._onObjectMatched, this);
            ...
            viewHeader: function (data) {
                ...
                var sUrl = url.split("/annullataNIRilievo/")[1]
            ...
            callPositionNI: function (oEvent) {
                ...
                for (var i = 0; i < header.length; i++) {
                    ...
                    if (header[i].Bukrs == oEvent.getParameters().arguments.campo &&
                        ...
                        this.getOwnerComponent().getModel().read("/PositionNISet", {
                            ...
                            success: function (data) {
                                ...
                                for (var dr = 0; dr < data.results.length; dr++) {
                                    ...
                                    that.getView().byId("annullataNIRilievo").getItems()[dr].mAggregations.cells[4].setText(totale)
                        ...
                        this.getOwnerComponent().setModel(oMdlITB, "annullataNIRilievo");
            ...
            onSelect: function (oEvent) {
                ...
                if (key === "dettagliNI") {
                    //this.callPositionNI()
                    this.getView().byId("annullataNIRilievoITB").destroyContent()
            ...
            onBackButton: function () {
                this.getView().byId("annullataNIRilievo").destroyItems()
